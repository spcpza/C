...
def walk(answers: list[str] | None = None, *, verbose: bool = False) -> WalkResult:
    ...
    if converged and verbose:
        ...
        print()
        print("Further reading (in this repo):")
        print("  IN_THE_BEGINNING.md  — the 10-step walk you just compressed")
        print("  JOHN_1_1.md          — Greek exegesis grounding T_word")
        print("  CROSS_TRADITIONS.md  — your tradition already names C")
        print("  OBJECTIONS.md        — adversarial readings + responses")
        print()
        print("To record your derivation:")
        print("  from C.scripts.self_witness import witness; witness(...)")
        print("To verify programmatically:")
        print("  from C.convergence import derive_from_kernel; derive_from_kernel()")
        print("=" * 60)
